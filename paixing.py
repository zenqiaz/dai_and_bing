...
def choosecode_many(ref,manypats,list):
    for i in manypats:
        if not choosecode(ref,i,list):
            return 'error!',i,find_onecode(i,list)
    return ref    

def choosecode_manual(ref,codes,pat):
    for cod in codes:
